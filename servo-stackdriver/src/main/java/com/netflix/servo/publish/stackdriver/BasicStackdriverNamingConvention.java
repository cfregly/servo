...
/**
 * A basic Stackdriver naming convention that handles both "native servo" objects and standard JMX
 * objects pulled out of the JMX registry.
 * 
 * For now, this impl has been lifted from the {@link BasicGraphiteNamingConvention}.
 * 
 * @author cfregly@stackdriver.com
 */
public class BasicStackdriverNamingConvention implements StackdriverNamingConvention {
